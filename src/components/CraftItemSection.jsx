            ...
            <div>
                ...
                <div className="card card-compact bg-base-100 shadow-xl flex-grow">
                    ...
                    <div className="card-body">
                        ...
                        <p><b>Short Description</b>:  {shortDescription?.slice(0, 120)}<Link to={`/details/${_id}`} className="text-primary">View Details</Link></p>
                        ...
                        <div className="card-actions ">
                            <div className="btn-group btn-group-horizontal space-x-4">
                                ...
                                <button
                                    onClick={() => handleDeleteItem(_id)} className="btn text-red-800"><MdDelete /></button>
                            </div>
                        </div>
                    </div>
                </div>
